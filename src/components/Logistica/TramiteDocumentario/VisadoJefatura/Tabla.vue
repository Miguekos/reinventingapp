  ...
  data() {
    return {
      ...
      columns: [
        ...
        { name: "no_tradoctradoc", label: "Orden Compra", field: "no_tradoc" },
  ...
  methods: {
    ...
    async agregar() {
      await this.call_manten_produc_tradoc({
        ...
        co_articu: this.co_articu,
        ca_articu: this.ca_articu,
        co_moneda: this.co_moneda,
        im_preuni: this.im_preuni,
        ti_accion: this.ti_accion
      });
    },
    async confirmar() {
      this.$q.loading.show();
